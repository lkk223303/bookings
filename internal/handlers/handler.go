...
import (
	...
	"github.com/lkk223303/bookings/internal/driver"
	"github.com/lkk223303/bookings/internal/forms"
	...
	"github.com/lkk223303/bookings/internal/repository/dbrepo"
...
// AvailabilityJSON response the availability date status
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	// Pull the reservational data from and type cast to models.Reservation
	reservation, ok := m.App.Session.Get(r.Context(), "reservation").(models.Reservation)
	if !ok {
...
// ChooseRoom display list of availability rooms
